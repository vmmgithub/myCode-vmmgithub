...
if [[ "$1" == "" ]]; then
   echo "Usage: $0 <buid> <startDate> <endDate>"
...
if [[ -z $startDate ]]
then
startDate="2013-08-04T00:00:00Z"
fi

if [[ -z $endDate ]]
then
endDate="2013-11-01T00:00:00Z"
fi
...
echo "Extracting data for ${buid} with ${startDate} and ${endDate} and dumping files into ${out}"
