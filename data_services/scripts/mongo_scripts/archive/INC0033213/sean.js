                    ...
                    async.series({
                        ...
                        if(err){
                            ...
                            if(!results.salesRep){
                                ...
                                fs.appendFileSync("backup/sean.log",record.opportunity + ": " + JSON.stringify(prevSalesRepRelationships,null,4));
                                fs.appendFileSync("backup/sean.log","\n");
...
//    console.log(data);
//})
csvHelper.readAsObj("./csv/Sean_UTF-8.csv",function(data){
