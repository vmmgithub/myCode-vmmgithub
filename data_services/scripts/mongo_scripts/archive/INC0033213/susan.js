                    ...
                    async.series({
                        ...
                        if(err){
                            ...
                            if(!results.salesRep){
                                ...
                                fs.appendFileSync("backup/susan.log",record.opportunity + ": " + JSON.stringify(prevSalesRepRelationships,null,4));
                                fs.appendFileSync("backup/susan.log","\n");
...
//    console.log(data);
//})
csvHelper.readAsObj("./csv/Susan_UTF-8.csv",function(data){
