                    ...
                    async.series({
                        ...
                        if(err){
                            ...
                            if(!results.salesRep){
                                ...
                                fs.appendFileSync("backup/susan_to_fix.log",record.opportunity + ": " + JSON.stringify(prevSalesRepRelationships,null,4));
                                fs.appendFileSync("backup/susan_to_fix.log","\n");
...
//    console.log(data);
//})
csvHelper.readAsObj("./csv/tofix/Susan_TO_FIX.csv",function(data){
