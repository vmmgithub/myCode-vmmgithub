                    ...
                    async.series({
                        ...
                        if(err){
                            ...
                            if(!results.salesRep){
                                ...
                                fs.appendFileSync("backup/burnell_left.log",record.opportunity + ": " + JSON.stringify(prevSalesRepRelationships,null,4));
                                fs.appendFileSync("backup/burnell_left.log","\n");
...
//    console.log(data);
//})
csvHelper.readAsObj("./csv/Burnell_Left_UTF-8.csv",function(data){
