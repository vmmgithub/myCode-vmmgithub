...
module.exports = function() {
    var API = function(host, port, username, password) {
        this.host = host || process.env.avalonhost || 'localhost';
        this.port = port || process.env.avalonport || "7000";
        this.username = username || process.env.user || 'bill.moor@dell.com';
        this.password = password || process.env.pass || 'passwordone';
    };
